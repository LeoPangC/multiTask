...
parser.add_argument("-opt", type=str, default='/home/hy4080/PycharmProjects/multiTask/Exp/denoising-sde/options/train/ir-sde.yml', required=True, help="Path to options YMAL file.")
