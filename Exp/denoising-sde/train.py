...
def main():
    ...
    parser.add_argument("-opt", type=str, default='/home/hy4080/PycharmProjects/multiTask/Exp/denoising-sde/options/train/ir-sde.yml', help="Path to option YMAL file.")
    ...
    for phase, dataset_opt in opt["datasets"].items():
        if phase == "train":
            gfsu_data = np.load(os.path.join(dataset_opt['dataroot'], gfsu_path))[:, :96, :96]
            era5u_data = np.load(os.path.join(dataset_opt['dataroot'], era5u_path))[:, :96, :96]
            gfsv_data = np.load(os.path.join(dataset_opt['dataroot'], gfsv_path))[:, :96, :96]
            era5v_data = np.load(os.path.join(dataset_opt['dataroot'], era5v_path))[:, :96, :96]
            ...
            train_loader = DataLoader(train_set, batch_size=dataset_opt['batch_size'], shuffle=dataset_opt['use_shuffle'], drop_last=False,
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            LQ, GT = train_data[0], train_data[1]
